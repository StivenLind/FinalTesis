...
TRAINING_DATASET_DIR = os.path.join(BASE_DIR, "Entrenamiento Data Set")
...
def guardar_captura():
    ...
    dataset_file_path = os.path.join(TRAINING_DATASET_DIR, file_name)
    ...
    return jsonify({
        "ok": True,
        "message": "Captura guardada en capturas y en Entrenamiento Data Set.",
        "archivo": file_name,
        "ruta_relativa": f"capturas/{file_name}",
        "ruta_dataset": f"Entrenamiento Data Set/{file_name}",
    })
